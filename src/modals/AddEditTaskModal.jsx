      ...
      >
        ...
        <div className="mt-8 flex flex-col space-y-3">
          ...
          <select
            ...
            className=" select-status flex-grow px-4 py-2 rounded-md text-sm bg-white dark:bg-[#2b2c37] focus:border-0  border-[1px] border-gray-300 focus:outline-[#635fc7] outline-none"
          >
